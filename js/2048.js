{//创建表格
	$($('body')[0]).html('<div id="my2048"><div id="myhead"><h1><a href="#"id="title2048">2048</a></h1><div id="headScore"><div id="nowScore">0</div><div id="bestScore">0</div></div><div id="gameIntro"><span id="describe">Play 2048 Game Online</br>Join the numbers and get to the 2048 tile!</span><div id="restart">New Game</div></div></div><div id="table2048" class="addafter"><div class="hang"><li class="item"></li><li class="item"></li><li class="item"></li><li class="item"></li></div><div class="hang"><li class="item"></li><li class="item"></li><li class="item"></li><li class="item"></li></div><div class="hang"><li class="item"></li><li class="item"></li><li class="item"></li><li class="item"></li></div><div class="hang"><li class="item"></li><li class="item"></li><li class="item"></li><li class="item"></li></div></div></div>');
}
{//为每一个元素定位
	for (let i = 0; i < 16; i++){
		$('.item')[i].style.left = (i%4)*107 + 'px';
		$('.item')[i].style.top = Math.floor((i/4))*107 + 'px';
	}
}
{
...
{//算法
	...
	var animate = function(level,vertical){
		$($('.hang')[level].children[vertical]).animate({
			padding:'10px',
			margin:'10px'
		},100);
		$($('.hang')[level].children[vertical]).animate({
